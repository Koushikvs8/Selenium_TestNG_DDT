...
import java.util.List;
	...
	public class ExtentReportLogicUtility implements ITestListener {
		...
		public void onStart(ITestContext context) {
			...
			sparkReporter=new ExtentSparkReporter(System.getProperty("user.dir")+"\\Reports\\ExtentReport\\"+repName);
		...
		public void onTestSuccess(ITestResult result) {
		 ...
		 public void onTestFailure(ITestResult result) {
			 ...
			 try {
					...
					String imgPath=BaseClass.CaptureScreenShot();
		 ...
		 public void  onFinish(ITestContext context) {
			 ...
			 String pathofExtentReport=System.getProperty("user.dir")+"\\Reports\\ExtentReport\\"+repName;
